...
// Chapters: resp | cardio | digest | endoc | neuro | osteo | uro | derm | infect | mental | sympt | autre
...
export const ICD10: Icd10Entry[] = [
  ...
  { code: "J44.1", desc: "Broncho-pneumopathie chronique obstructive (BPCO) avec exacerbation aiguë", chapter: "resp" },
  ...
  { code: "J98.0", desc: "Maladies des bronches, sans précision",                    chapter: "resp" },
  ...
  { code: "M79.3", desc: "Panniculite, sans précision",                              chapter: "osteo" },
  ...
  { code: "R68.8", desc: "Autres symptômes et signes généraux précisés",             chapter: "sympt" },
  ...
  { code: "R79.8", desc: "Autres anomalies biochimiques précisées du sang",          chapter: "sympt" },
  ...
  { code: "S39.9", desc: "Traumatisme de l'abdomen, du bas du dos et du bassin",     chapter: "autre" },
...
export function searchIcd10(query: string, chapter?: Icd10Chapter): Icd10Entry[] {
  ...
  let pool = chapter ? ICD10.filter((e) => e.chapter === chapter) : ICD10;

  if (!q) return pool;

  // Tokenise: all tokens must match either code or description
